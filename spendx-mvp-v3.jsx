...
const T = {
  ...
  apStep1t: { en: "Open Wallet app", ru: "Откройте Wallet", uk: "Відкрийте Wallet", de: "Wallet öffnen", es: "Abrir Wallet", tr: "Wallet'ı açın" },
  apStep1d: { en: "Open the Wallet app on your iPhone or go to Settings → Wallet & Apple Pay", ru: "Откройте Wallet на iPhone или перейдите в Настройки → Wallet и Apple Pay", uk: "Відкрийте Wallet на iPhone або перейдіть до Налаштування → Wallet та Apple Pay", de: "Öffnen Sie die Wallet-App oder gehen Sie zu Einstellungen → Wallet & Apple Pay", es: "Abra Wallet en su iPhone o vaya a Ajustes → Wallet y Apple Pay", tr: "iPhone'da Wallet'ı açın veya Ayarlar → Wallet ve Apple Pay'e gidin" },
  apStep2t: { en: "Tap the + button", ru: "Нажмите +", uk: "Натисніть +", de: "Tippen Sie auf +", es: "Pulse +", tr: "+ düğmesine dokunun" },
  apStep2d: { en: "Tap the \"+\" button in the top-right corner to add a new card", ru: "Нажмите \"+\" в правом верхнем углу для добавления карты", uk: "Натисніть \"+\" у правому верхньому куті для додавання картки", de: "Tippen Sie auf \"+\" oben rechts, um eine Karte hinzuzufügen", es: "Pulse \"+\" en la esquina superior derecha para añadir una tarjeta", tr: "Yeni kart eklemek için sağ üst köşedeki \"+\" düğmesine dokunun" },
  apStep3t: { en: "Choose Debit or Credit Card", ru: "Выберите дебетовую карту", uk: "Оберіть дебетову картку", de: "Debit- oder Kreditkarte wählen", es: "Elegir tarjeta de débito", tr: "Banka veya Kredi Kartı seçin" },
  apStep3d: { en: "Select \"Debit or Credit Card\" and tap Continue", ru: "Выберите \"Дебетовая или кредитная карта\" и нажмите Продолжить", uk: "Оберіть \"Дебетова або кредитна картка\" і натисніть Продовжити", de: "Wählen Sie \"Debit- oder Kreditkarte\" und tippen Sie auf Weiter", es: "Seleccione \"Tarjeta de débito o crédito\" y pulse Continuar", tr: "\"Banka veya Kredi Kartı\" seçin ve Devam'a dokunun" },
  apStep4t: { en: "Scan or enter card details", ru: "Сканируйте или введите данные", uk: "Скануйте або введіть дані", de: "Karte scannen oder eingeben", es: "Escanear o ingresar datos", tr: "Kart bilgilerini tarayın veya girin" },
  apStep4d: { en: "Use camera to scan or manually enter your SpendX card number, expiry date, and CVV", ru: "Используйте камеру для сканирования или введите номер карты SpendX, срок действия и CVV вручную", uk: "Використовуйте камеру для сканування або введіть номер картки SpendX, термін дії та CVV вручну", de: "Scannen Sie mit der Kamera oder geben Sie Kartennummer, Ablaufdatum und CVV manuell ein", es: "Use la cámara para escanear o ingrese manualmente el número, fecha y CVV", tr: "Kamerayı kullanarak tarayın veya SpendX kart numarası, son kullanma tarihi ve CVV'yi manuel girin" },
  apStep5t: { en: "Verify", ru: "Подтвердите", uk: "Підтвердіть", de: "Verifizieren", es: "Verificar", tr: "Doğrulayın" },
  apStep5d: { en: "Accept the terms & conditions. Your card will be verified automatically", ru: "Примите условия использования. Карта будет подтверждена автоматически", uk: "Прийміть умови використання. Картка буде підтверджена автоматично", de: "Akzeptieren Sie die Bedingungen. Ihre Karte wird automatisch verifiziert", es: "Acepte los términos. Su tarjeta se verificará automáticamente", tr: "Şartları kabul edin. Kartınız otomatik olarak doğrulanacak" },
  apStep6t: { en: "Done!", ru: "Готово!", uk: "Готово!", de: "Fertig!", es: "¡Listo!", tr: "Tamam!" },
  apStep6d: { en: "Your SpendX card is now ready. Use it for contactless payments everywhere Apple Pay is accepted", ru: "Ваша карта SpendX готова. Используйте для бесконтактных платежей везде, где принимается Apple Pay", uk: "Ваша картка SpendX готова. Використовуйте для безконтактних платежів скрізь, де приймається Apple Pay", de: "Ihre SpendX-Karte ist bereit. Nutzen Sie sie für kontaktlose Zahlungen überall wo Apple Pay akzeptiert wird", es: "Su tarjeta SpendX está lista. Úsela para pagos sin contacto donde se acepte Apple Pay", tr: "SpendX kartınız hazır. Apple Pay'in kabul edildiği her yerde temassız ödeme yapın" },
  apCompat: { en: "Also compatible with", ru: "Также совместимо с", uk: "Також сумісно з", de: "Auch kompatibel mit", es: "También compatible con", tr: "Ayrıca uyumlu:" },
  ...
  physCopyExisting: { en: "Physical copy of existing card", ru: "Физическая копия существующей карты", uk: "Фізична копія існуючої картки", de: "Physische Kopie der bestehenden Karte", es: "Copia física de tarjeta existente", tr: "Mevcut kartın fiziksel kopyası" },
  physNewCard: { en: "Order new card as physical", ru: "Заказать новую карту физически", uk: "Замовити нову картку фізично", de: "Neue Karte physisch bestellen", es: "Ordenar nueva tarjeta física", tr: "Yeni fiziksel kart sipariş et" },
  selectCard: { en: "Select card", ru: "Выберите карту", uk: "Оберіть картку", de: "Karte wählen", es: "Seleccionar tarjeta", tr: "Kart seçin" },
  selectCardTier: { en: "Select card tier", ru: "Выберите уровень карты", uk: "Оберіть рівень картки", de: "Kartenstufe wählen", es: "Seleccionar nivel", tr: "Kart seviyesi seçin" },
  physCardIssue: { en: "Physical card issue", ru: "Выпуск физической карты", uk: "Випуск фізичної картки", de: "Physische Kartenausgabe", es: "Emisión de tarjeta física", tr: "Fiziksel kart basımı" },
  virtualCardPrice: { en: "Virtual card price", ru: "Цена виртуальной карты", uk: "Ціна віртуальної картки", de: "Preis der virtuellen Karte", es: "Precio de tarjeta virtual", tr: "Sanal kart fiyatı" },
  firstCardDiscount: { en: "First card discount -25%", ru: "Скидка на первую карту -25%", uk: "Знижка на першу картку -25%", de: "Erstkartenrabatt -25%", es: "Descuento primera tarjeta -25%", tr: "İlk kart indirimi -%25" },
  voucherApplied: { en: "Voucher -50% applied", ru: "Ваучер -50% применён", uk: "Ваучер -50% застосовано", de: "Gutschein -50% angewendet", es: "Cupón -50% aplicado", tr: "Kupon -%50 uygulandı" },
  totalPrice: { en: "Total", ru: "Итого", uk: "Разом", de: "Gesamt", es: "Total", tr: "Toplam" },
  youOwn: { en: "You own", ru: "У вас есть", uk: "У вас є", de: "Sie besitzen", es: "Usted tiene", tr: "Sahip olduğunuz" },
  noCardsYet: { en: "No cards yet - first card gets 25% off!", ru: "Карт ещё нет - первая карта со скидкой 25%!", uk: "Карток ще немає - перша картка зі знижкою 25%!", de: "Noch keine Karten - erste Karte 25% Rabatt!", es: "Sin tarjetas - ¡primera tarjeta con 25% de descuento!", tr: "Henüz kart yok - ilk kart %25 indirimli!" },
  ...
  noCardsDesc2: { en: "Choose from 5 card tiers with different limits and fees to match your needs", ru: "Выберите из 5 уровней карт с разными лимитами и комиссиями", uk: "Оберіть з 5 рівнів карток з різними лімітами та комісіями", de: "Wählen Sie aus 5 Kartenstufen", es: "Elige entre 5 niveles de tarjeta", tr: "İhtiyaçlarınıza uygun 5 kart seviyesinden birini seçin" },
  ...
  phoneNumber: { en: "PHONE NUMBER", ru: "НОМЕР ТЕЛЕФОНА", uk: "НОМЕР ТЕЛЕФОНУ", de: "TELEFONNUMMER", es: "TELÉFONO", tr: "TELEFON NUMARASI" },
  codeSentTo: { en: "We sent a 6-digit code to", ru: "Мы отправили 6-значный код на", uk: "Ми надіслали 6-значний код на", de: "Wir haben einen 6-stelligen Code gesendet an", es: "Enviamos un código de 6 dígitos a", tr: "6 haneli kodu gönderdik:" },
  resendOrChange: { en: "Resend code or change number", ru: "Отправить повторно или сменить номер", uk: "Надіслати повторно або змінити номер", de: "Code erneut senden oder Nummer ändern", es: "Reenviar código o cambiar número", tr: "Kodu tekrar gönder veya numarayı değiştir" },
  smsEnabled: { en: "SMS 2FA Enabled", ru: "SMS 2FA включён", uk: "SMS 2FA увімкнено", de: "SMS 2FA aktiviert", es: "SMS 2FA habilitado", tr: "SMS 2FA etkinleştirildi" },
  codesSentTo: { en: "Verification codes will be sent to", ru: "Коды подтверждения будут отправлены на", uk: "Коди підтвердження надсилатимуться на", de: "Bestätigungscodes werden gesendet an", es: "Los códigos se enviarán a", tr: "Doğrulama kodları gönderilecek:" },
  done: { en: "Done", ru: "Готово", uk: "Готово", de: "Fertig", es: "Listo", tr: "Tamam" },
  scanQRCode: { en: "Scan QR Code", ru: "Сканируйте QR-код", uk: "Скануйте QR-код", de: "QR-Code scannen", es: "Escanear código QR", tr: "QR kodunu tarayın" },
...
const ApplePayGuide = () => {
  ...
  const steps = [
    { num: "1", title: t("apStep1t"), desc: t("apStep1d") },
    { num: "2", title: t("apStep2t"), desc: t("apStep2d") },
    { num: "3", title: t("apStep3t"), desc: t("apStep3d") },
    { num: "4", title: t("apStep4t"), desc: t("apStep4d") },
    { num: "5", title: t("apStep5t"), desc: t("apStep5d") },
    { num: "6", title: t("apStep6t"), desc: t("apStep6d") },
  ];
  return (
    <div>
      ...
      {open && (
        <Glass style={{ marginTop: 8, padding: "4px 0", overflow: "hidden", animation: "fade-up .25s ease both" }}>
          ...
          <div style={{ padding: "10px 16px", background: `${C.accent}08`, display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <span style={{ color: C.muted, fontSize: 11, fontFamily: "DM Sans, sans-serif" }}>{t("apCompat")} <span style={{ color: C.silver, fontWeight: 600 }}>Google Pay</span> & <span style={{ color: C.silver, fontWeight: 600 }}>Samsung Pay</span></span>
          </div>
        </Glass>
      )}
    </div>
        ...
        {settingsOpen && (
          <div style={{ marginTop: 8, display: "flex", flexDirection: "column", gap: 8, animation: "fade-up .25s ease both" }}>
            <button className="outline-btn" style={{
              ...
              <Ico d={ic.lock} size={15} color={C.yellow} /> {t("setPinCode")}
            </button>
            <button className="outline-btn" style={{
              width: "100%", padding: "14px 20px", borderRadius: 16,
              background: `${C.yellow}12`, border: `1px solid ${C.yellow}35`,
              ...
              <Ico d={ic.card} size={15} color={C.yellow} /> {t("replaceCard")}
            </button>
          </div>
        )}
      </div>
...
const PhysicalCardSheet = ({ onClose, myCards }) => {
  const t = useT();
  const [reserved, setReserved] = useState(false);
  const [mode, setMode] = useState(null); // null | "copy" | "new"
  const [selectedCard, setSelectedCard] = useState(null); // for copy mode - owned card
  const [selectedTier, setSelectedTier] = useState(null); // for new mode - CARD_TYPES entry
  ...
  const PHYS_PRICE = 30; // pre-order
  const PHYS_REGULAR = 58;
  const hasVoucher = (tier) => tier === "Supreme" || tier === "Business";

  // Calculate price
  const calcPrice = () => {
    if (mode === "copy" && selectedCard) {
      const physPrice = hasVoucher(selectedCard.tier) ? PHYS_PRICE * 0.5 : PHYS_PRICE;
      return { phys: physPrice, card: 0, discount: hasVoucher(selectedCard.tier), total: physPrice, tier: selectedCard.tier };
    }
    if (mode === "new" && selectedTier) {
      const cardPrice = parseFloat(selectedTier.price.replace("$", ""));
      const isFirst = !myCards || myCards.length === 0;
      const cardFinal = isFirst ? cardPrice * 0.75 : cardPrice;
      const physPrice = hasVoucher(selectedTier.tier) ? PHYS_PRICE * 0.5 : PHYS_PRICE;
      return { phys: physPrice, card: cardFinal, cardOrig: cardPrice, isFirst, discount: hasVoucher(selectedTier.tier), total: cardFinal + physPrice, tier: selectedTier.tier };
    }
    return null;
  };
  ...
  return (
    <div className="sheet-anim" style={{ background: C.navy, minHeight: "100%", paddingBottom: 20 }}>
      <div style={{ display: "flex", alignItems: "center", padding: "14px 20px", borderBottom: `1px solid ${C.gridSep}44` }}>
        <CircleBtn icon="back" color={C.panelLight} iconColor={C.silver} size={34} shadow={false} onClick={() => { if (mode && !reserved) setMode(null); else onClose(); }} />
      ...
      <div style={{ padding: 20 }}>
        ...
        <Glass className="s2 glow-border-slow" style={{ padding: 18, marginBottom: 16, borderRadius: 20 }}>
          ...
          <div style={{ height: 8, borderRadius: 50, background: C.panelLight, overflow: "hidden", marginBottom: 8 }}>
            <div style={{ height: "100%", width: `${pct}%`, borderRadius: 50, background: `linear-gradient(90deg, ${C.amber}, ${C.yellow})`, boxShadow: `0 0 10px ${C.yellow}40`, transition: "width 1s ease" }} />
          </div>
        ...
        {/* ─── MODE SELECTION ─── */}
        {!mode && !reserved && (
          <div className="s4" style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 16 }}>
            {/* Option 1: Copy existing */}
            {myCards && myCards.length > 0 && (
              <button className="outline-btn glass-btn" onClick={() => setMode("copy")} style={{
                width: "100%", padding: "16px 18px", borderRadius: 16,
                background: `${C.accent}08`, border: `1px solid ${C.accent}30`,
                color: C.silver, fontSize: 13, fontWeight: 600, fontFamily: "DM Sans, sans-serif",
                display: "flex", alignItems: "center", gap: 12, cursor: "pointer", textAlign: "left",
              }}>
                <Ico d={ic.card} size={20} color={C.accent2} />
                <div style={{ flex: 1 }}>
                  <div style={{ color: C.white, fontSize: 13, fontWeight: 600 }}>{t("physCopyExisting")}</div>
                  <div style={{ color: C.muted, fontSize: 10, marginTop: 2 }}>{t("youOwn")} {myCards.length} {myCards.length === 1 ? t("card").toLowerCase() : t("cards").toLowerCase()}</div>
                </div>
                <Ico d={ic.chevron} size={14} color={C.muted} />
              </button>
            )}
            {/* Option 2: New card */}
            <button className="outline-btn glass-btn" onClick={() => setMode("new")} style={{
              width: "100%", padding: "16px 18px", borderRadius: 16,
              background: `${C.yellow}08`, border: `1px solid ${C.yellow}30`,
              color: C.silver, fontSize: 13, fontWeight: 600, fontFamily: "DM Sans, sans-serif",
              display: "flex", alignItems: "center", gap: 12, cursor: "pointer", textAlign: "left",
            }}>
              <Ico d={ic.topup} size={20} color={C.yellow} />
              <div style={{ flex: 1 }}>
                <div style={{ color: C.white, fontSize: 13, fontWeight: 600 }}>{t("physNewCard")}</div>
                <div style={{ color: C.muted, fontSize: 10, marginTop: 2 }}>
                  {myCards && myCards.length > 0 ? t("selectCardTier") : t("noCardsYet")}
                </div>
              </div>
              <Ico d={ic.chevron} size={14} color={C.muted} />
            </button>
        ...
        {/* ─── COPY MODE: select owned card ─── */}
        {mode === "copy" && !selectedCard && (
          <div className="s4" style={{ marginBottom: 16 }}>
            <div style={{ color: C.muted, fontSize: 11, fontFamily: "DM Sans, sans-serif", textTransform: "uppercase", letterSpacing: 1, marginBottom: 10 }}>{t("selectCard")}</div>
            {myCards.map(c => (
              <button key={c.id} className="outline-btn glass-btn" onClick={() => setSelectedCard(c)} style={{
                width: "100%", padding: "14px 16px", borderRadius: 14, marginBottom: 8,
                background: "transparent", border: `1px solid ${C.cardBorder}55`,
                color: C.silver, fontSize: 13, fontWeight: 500, fontFamily: "DM Sans, sans-serif",
                display: "flex", alignItems: "center", gap: 12, cursor: "pointer",
              }}>
                <div style={{ width: 36, height: 24, borderRadius: 6, background: c.color || C.accent, flexShrink: 0 }} />
                <div style={{ flex: 1, textAlign: "left" }}>
                  <span style={{ color: C.white, fontWeight: 600 }}>{c.tier}</span>
                  <span style={{ color: C.muted, fontSize: 11, marginLeft: 8 }}>** {c.last4}</span>
                </div>
                {hasVoucher(c.tier) && <span style={{ color: C.yellow, fontSize: 10, fontWeight: 700, fontFamily: "DM Sans, sans-serif" }}>-50%</span>}
                <Ico d={ic.chevron} size={14} color={C.muted} />
              </button>
            ))}
          </div>
        ...
        {/* ─── NEW MODE: select tier ─── */}
        {mode === "new" && !selectedTier && (
          <div className="s4" style={{ marginBottom: 16 }}>
            <div style={{ color: C.muted, fontSize: 11, fontFamily: "DM Sans, sans-serif", textTransform: "uppercase", letterSpacing: 1, marginBottom: 10 }}>{t("selectCardTier")}</div>
            {CARD_TYPES.map(c => (
              <button key={c.id} className="outline-btn glass-btn" onClick={() => setSelectedTier(c)} style={{
                width: "100%", padding: "14px 16px", borderRadius: 14, marginBottom: 8,
                background: "transparent", border: `1px solid ${c.bestValue ? C.yellow + "40" : C.cardBorder + "55"}`,
                color: C.silver, fontSize: 13, fontWeight: 500, fontFamily: "DM Sans, sans-serif",
                display: "flex", alignItems: "center", gap: 12, cursor: "pointer",
              }}>
                <div style={{ width: 36, height: 24, borderRadius: 6, background: c.color || C.accent, flexShrink: 0 }} />
                <div style={{ flex: 1, textAlign: "left" }}>
                  <span style={{ color: C.white, fontWeight: 600 }}>{c.tier}</span>
                  <span style={{ color: C.muted, fontSize: 11, marginLeft: 8 }}>{c.price}</span>
                </div>
                {hasVoucher(c.tier) && <span style={{ color: C.yellow, fontSize: 10, fontWeight: 700, fontFamily: "DM Sans, sans-serif" }}>-50%</span>}
                <Ico d={ic.chevron} size={14} color={C.muted} />
              </button>
        ...
        {price && !reserved && (
          <Glass className="s4" style={{ padding: 16, marginBottom: 16 }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
              <span style={{ color: C.white, fontSize: 14, fontWeight: 700, fontFamily: "DM Sans, sans-serif" }}>{price.tier}</span>
              {price.discount && <Badge text={t("voucherApplied")} color={C.yellow} />}
            </div>

            {/* Virtual card line (new mode only) */}
            {mode === "new" && (
              <div style={{ display: "flex", justifyContent: "space-between", padding: "8px 0", borderBottom: `1px solid ${C.gridSep}33` }}>
                <span style={{ color: C.muted, fontSize: 12, fontFamily: "DM Sans, sans-serif" }}>{t("virtualCardPrice")}</span>
                <div style={{ textAlign: "right" }}>
                  {price.isFirst && <span style={{ color: C.muted, fontSize: 11, textDecoration: "line-through", marginRight: 6 }}>${price.cardOrig}</span>}
                  <span style={{ color: C.silver, fontSize: 13, fontWeight: 600, fontFamily: "DM Sans, sans-serif" }}>${price.card.toFixed(2)}</span>
                  {price.isFirst && <div style={{ color: C.green, fontSize: 10, fontFamily: "DM Sans, sans-serif" }}>{t("firstCardDiscount")}</div>}
                </div>
              </div>
            )}
            ...
            {/* Physical card line */}
            <div style={{ display: "flex", justifyContent: "space-between", padding: "8px 0", borderBottom: `1px solid ${C.gridSep}33` }}>
              <span style={{ color: C.muted, fontSize: 12, fontFamily: "DM Sans, sans-serif" }}>{t("physCardIssue")}</span>
              <div style={{ textAlign: "right" }}>
                <span style={{ color: C.muted, fontSize: 11, textDecoration: "line-through", marginRight: 6 }}>${price.discount ? PHYS_PRICE : PHYS_REGULAR}</span>
                <span style={{ color: C.silver, fontSize: 13, fontWeight: 600, fontFamily: "DM Sans, sans-serif" }}>${price.phys.toFixed(2)}</span>
                {price.discount && <div style={{ color: C.yellow, fontSize: 10, fontFamily: "DM Sans, sans-serif" }}>-50%</div>}
              </div>
            </div>

            {/* Total */}
            <div style={{ display: "flex", justifyContent: "space-between", padding: "10px 0 0" }}>
              <span style={{ color: C.white, fontSize: 14, fontWeight: 700, fontFamily: "DM Sans, sans-serif" }}>{t("totalPrice")}</span>
              <span style={{ color: C.green, fontSize: 18, fontWeight: 800, fontFamily: "DM Sans, sans-serif" }}>${price.total.toFixed(2)}</span>
            </div>

            {/* Voucher info for non-supreme/business */}
            {!price.discount && (
        ...
        <div className="s5">
          {reserved ? (
            ...
            <PillBtn bg={C.yellow} color={C.navy} full onClick={() => setReserved(true)}>
              <Ico d={ic.card} size={16} color={C.navy} sw={2} /> {t("preOrderNow")} - ${price.total.toFixed(2)}
            </PillBtn>
          ) : null}
        </div>
      </div>
      ...
      <div style={{ padding: 20 }}>
        ...
        {method === "sms" && !smsVerified && (
          <>
            <div style={{ color: C.white, fontSize: 15, fontWeight: 600, fontFamily: "DM Sans, sans-serif", marginBottom: 16 }}>
              {smsSent ? t("enterCode") : t("enterPhone")}
            </div>

            {!smsSent ? (
              <>
                <Glass style={{ padding: 14, marginBottom: 14 }}>
                  <div style={{ color: C.muted, fontSize: 10, fontFamily: "DM Sans, sans-serif", textTransform: "uppercase", letterSpacing: 1, marginBottom: 8 }}>{t("phoneNumber")}</div>
              ...
              <>
                <div style={{ color: C.muted, fontSize: 12, fontFamily: "DM Sans, sans-serif", marginBottom: 14 }}>
                  {t("codeSentTo")} <span style={{ color: C.silver, fontWeight: 600 }}>{phone}</span>
                </div>
                <Glass style={{ padding: 14, marginBottom: 14 }}>
                ...
                <PillBtn bg={C.yellow} color={C.navy} full onClick={() => { if (smsCode.length === 6) { setSmsVerified(true); showToast("SMS 2FA enabled"); } }}>
                  <Ico d={ic.check} size={16} color={C.navy} sw={2.5} /> {t("verify")}
                </PillBtn>
                <div onClick={() => setSmsSent(false)} style={{ textAlign: "center", marginTop: 14, cursor: "pointer" }}>
                  <span className="link-glow" style={{ color: C.muted, fontSize: 12, fontFamily: "DM Sans, sans-serif" }}>{t("resendOrChange")}</span>
                </div>
              </>
            )}
          </>
        ...
        {method === "sms" && smsVerified && (
          <div style={{ textAlign: "center", padding: "20px 0" }}>
            ...
            <div style={{ color: C.white, fontSize: 16, fontWeight: 700, fontFamily: "DM Sans, sans-serif" }}>{t("smsEnabled")}</div>
            <div style={{ color: C.muted, fontSize: 12, fontFamily: "DM Sans, sans-serif", marginTop: 6 }}>{t("codesSentTo")} {phone}</div>
        ...
        {method === "google" && gaStep === 0 && (
          <>
            ...
            {/* Steps */}
            {[
              { n: "1", t: t("installApp"), d: t("installDesc") },
              { n: "2", t: t("scanQR"), d: t("scanDesc") },
              { n: "3", t: t("enterVerCode"), d: t("enterVerDesc") },
            ].map((s, i) => (
        ...
        {method === "google" && gaStep === 1 && (
          <>
            <div style={{ color: C.white, fontSize: 15, fontWeight: 600, fontFamily: "DM Sans, sans-serif", marginBottom: 16 }}>{t("scanQRCode")}</div>
        ...
        {method === "google" && gaStep === 2 && (
          <>
            <div style={{ color: C.white, fontSize: 15, fontWeight: 600, fontFamily: "DM Sans, sans-serif", marginBottom: 6 }}>{t("enterVerCode")}</div>
        ...
        {method === "google" && gaStep === 3 && (
          <div style={{ textAlign: "center", padding: "20px 0" }}>
            ...
            <div style={{ color: C.white, fontSize: 16, fontWeight: 700, fontFamily: "DM Sans, sans-serif" }}>{t("gaEnabled")}</div>
...
const SettingsScreen = ({ lang, setLang, showToast, kycStatus, setKycStatus, myCards }) => {
  const t = useT();
  ...
  if (preorderOpen) return <PhysicalCardSheet onClose={() => setPreorderOpen(false)} myCards={myCards} />;
          ...
          <Glass className="glass-btn" onClick={() => setPreorderOpen(true)} style={{
            ...
            <div style={{
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10, position: "relative", zIndex: 1 }}>
                ...
                <div>
                  <div style={{ color: C.white, fontSize: 13, fontWeight: 700, fontFamily: "DM Sans, sans-serif" }}>{t("physicalCard")}</div>
...
const CardShopSheet = ({ onClose, orderCard, ownedCards, kycStatus, setKycStatus, showToast }) => {
  ...
  if (payingCard) {
    ...
    const payAmount = payingCard._displayPrice || payingCard.price;
    const showDiscount = payingCard._isFirst;
              ...
              <div style={{ padding: "12px 18px" }}>
                ...
                <div style={{ marginTop: 8 }}>
                  {kycStatus !== "verified" ? (
                    ...
                    <PillBtn bg={C.accent2} color={C.white} full onClick={() => setConfirmCard({ ...card, _displayPrice: displayPrice, _isFirst: isFirstCard })} style={{ padding: "12px 0", fontSize: 13 }}>
        ...
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,.7)", backdropFilter: "blur(6px)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 100, padding: 30 }} onClick={() => setConfirmCard(null)}>
          <Glass onClick={e => e.stopPropagation()} style={{ padding: 24, maxWidth: 320, width: "100%", borderRadius: 24, border: `1px solid ${C.yellow}30`, animation: "fade-up .25s ease both" }}>
            <div style={{ textAlign: "center", marginBottom: 16 }}>
              ...
              <div style={{ color: C.muted, fontSize: 12, fontFamily: "DM Sans, sans-serif", marginTop: 6 }}>{t("issuanceFeeColon")} <span style={{ color: C.green, fontWeight: 700 }}>{confirmCard._displayPrice}</span></div>
            </div>
            {[
...
export default function SpendXMVP3() {
  ...
  const screens = {
    ...
    settings: <SettingsScreen lang={lang} setLang={setLang} showToast={showToast} kycStatus={kycStatus} setKycStatus={setKycStatus} myCards={myCards} />,
  };
  const sheets = {
